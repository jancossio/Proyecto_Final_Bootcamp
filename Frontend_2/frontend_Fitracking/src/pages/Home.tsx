    ...
    <main id="home-page">
      <nav className="navbar">
        <ul className="nav-list">
          ...
          <li>
            <a href="/Recomendaciones" className="nav-item">
              Recomendaciones
            </a>
          </li>
          <li>
      ...
      <div className="containersobrenosotros appear" id="Quienes-somos">
        ...
        <p>
          ...
          trabajan con dedicación para crear soluciones accesibles y
          sostenibles. Nos especializamos en guiar a nuestros clientes hacia un
          estilo de vida equilibrado, promoviendo no solo una alimentación
          saludable, sino también la práctica de ejercicio, el cuidado emocional
          y el desarrollo de hábitos positivos. <br />
          ...
          salud, inspirándolas a vivir con energía, vitalidad y felicidad.
          Estamos comprometidos con aportar a la sociedad no solo mediante la
          mejora de la calidad de vida de nuestros clientes, sino también a
          través de iniciativas que promuevan una cultura de salud y
          sostenibilidad. Nuestro objetivo es crear una comunidad donde cada
          paso hacia un estilo de vida saludable sea un paso hacia un futuro más
          pleno para todos. <br />
